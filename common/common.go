...
const (
	QUESTION_TYPE_SINGLE_RADIO      = "SINGLE_RADIO"
	QUESTION_TYPE_SINGLE_SELECTION  = "SINGLE_SELECTION"
	QUESTION_TYPE_FILL_IN_THE_BLANK = "GAP_FILL_IN_BLANK"
